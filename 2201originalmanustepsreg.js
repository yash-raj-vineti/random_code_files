...
export default {
    ...
    collectionSiteLabels: {
        ...
        nextButtonNegativeAll: () => {
            cy.log('Verify the "Next" Button when the step is not signed.')
            inputCheckHelpers.nextButtonCheck('be.disabled')
        },
        // C24384
        printLabelsPositive: () => {
            cy.log('Verify the "Print Labels" buttons.')
            inputCheckHelpers.printLabelsCheck()
            inputCheckHelpers.printLabelsCheck(1)
        }
    },
    ...
    shipLabelsToCollectionSite: {
        ...
        //C24393
        nextButtonNoCoi: () => {
            cy.log('[NEG] Verify the next button when COI is not filled and "Pack the Shipper" toggle is set.');
            inputChecker.clickOnCheck('[data-testid="pass-button-mfg_materials_into_shipper"]','be.disabled');
        },
         // C24390
        invalidCoiNegative: () => {
            cy.log('[NEG] Verify functionality of COI block.')
        ...
        // C24398
        nextButtonNoToggleClick: () => {
            cy.log('[NEG] Verify the next button when "Pack the Shipper" toggle is not set and COI is filled. ');
            cy.get('@coi').then(coi =>{
        ...
        // C24454
        nextButtonNoToggle: () => {
            cy.log('[POS] Verify the next button when the "Pack the Shipper" toggle is set to "NO"');
            inputChecker.clickOnCheck('[data-testid="fail-button-mfg_materials_into_shipper"]', 'be.disabled');
            inputChecker.inputSingleFieldCheck('[data-testid="#/properties/shipping_checklist/properties/mfg_materials_into_shipper_reason-input"]','Reason','not.be.disabled');
        },
    },
    ...
    labelShippingSummary:{
        ...
        // C24401
        nextButtonNegativeAll: () => {
            cy.log('[NEG]Verify the "Next" Button when the step is not signed.')
            inputCheckHelpers.nextButtonCheck('be.disabled')
        },
         // C24406
        signatureNotConfirmed: () => {
            cy.log('[NEG] Verify the "Print Summary" Button when the step is not signed. ');
            inputChecker.checkState("[data-test-id='view-document-block'] >>>", 'be.disabled');
        },

        // C24407
        signatureConfirmed: () => {
            cy.log('[POS] Verify the "Print Summary" Button when the step is signed.');
    ...
    productReceipt: {
        ...
        bag1CoiNegative: () => {
            ...
            cy.get('@coi').then(coi =>{
                ...
                inputCheckHelpers.bagIdentifierClearCoi('bag-1-identifier-1', `${coi}-PRC-03`, 'be.disabled');
                inputCheckHelpers.bagIdentifierClearCoi('bag-1-identifier-1', `${coi}-PRC-03-APH-01`, 'be.disabled');
            });
        },
    ...
    shippingBagSelection: {
        ...
        nextButtonPositive: () => {
            inputChecker.clickOnCheck('[data-testid="fail-button-0"]','not.be.disabled')
        }
    },

    airwayBill: {
        getManufacturingAirWayBill: (scope, testId) => {
            ...
            cy.get('@coi').then(coi =>{
                ...
                if (testId) {
                    inputHelpers.inputSingleField(`[data-testid="${testId}"]`,scope.manufacturingAirWayBill);
                  } else {
                    inputHelpers.inputSingleField('[data-testid="manufacturing-airway-bill-input-field"]',scope.manufacturingAirWayBill);
                    inputHelpers.clicker('[data-testid="manufacturing-airway-bill-action-trigger-button"]');
                  }
    ...
    shippingChecklist: {
        ...
        //C24347
        confirmButtonNegative: () => {
            inputChecker.identifierCoiLabelCheck('manufacturing-airway-bill','abcd','be.disabled');
            inputChecker.identifierCoiLabelCheck('manufacturing-airway-bill','12345','be.disabled');
            inputChecker.identifierCoiLabelCheck('manufacturing-airway-bill','@#$%','be.disabled');          
        },
        //C24509
        enterAndConfirmNegative: () => {
            inputChecker.enterAndConfirmNegativeCheck('infusion_shipper_serial_number','123','111','not.be.disabled','be.disabled');
        },
        //C24484
        attachShippingLabelNegative: (scope) => {
            inputHelpers.clicker('[data-testid="fail-button-ship_to_infusion_attach_shipping_label"]');
            inputChecker.clearField('[data-testid="#/properties/shipping_checklist/properties/ship_to_infusion_attach_shipping_label_reason-input"]');
            ...
            inputHelpers.inputEnterAndConfirm('infusion_shipper_serial_number',input.mfgShippingChecklistInfusionShipperSerialNumber);
            inputChecker.nextButtonCheck('be.disabled');
        },
        //C24491
        placeTheMaterialNegative: () => {
            inputHelpers.clicker('[data-testid="pass-button-ship_to_infusion_attach_shipping_label"]');
            inputHelpers.clicker('[data-testid="fail-button-ship_to_infusion_place_material_into_shipper"]');
            inputChecker.clearField('[data-testid="#/properties/shipping_checklist/properties/ship_to_infusion_place_material_into_shipper_reason-input"]');
            inputHelpers.clicker('[data-testid="pass-button-ship_to_infusion_activate_temperature_monitor"]');
            inputHelpers.clicker('[data-testid="pass-button-ship_to_infusion_place_summary_document"]');
            inputChecker.nextButtonCheck('be.disabled');
        },
        //C24492
        activateTheTemperatureNegative: () => {
            inputHelpers.clicker('[data-testid="pass-button-ship_to_infusion_attach_shipping_label"]');
            inputHelpers.clicker('[data-testid="pass-button-ship_to_infusion_place_material_into_shipper"]');
            inputHelpers.clicker('[data-testid="fail-button-ship_to_infusion_activate_temperature_monitor"]');
            inputChecker.clearField('[data-testid="#/properties/shipping_checklist/properties/ship_to_infusion_activate_temperature_monitor_reason-input"]');
            inputHelpers.clicker('[data-testid="pass-button-ship_to_infusion_place_summary_document"]');
            inputChecker.nextButtonCheck('be.disabled');
        },
        //C24494
        placeSummaryDocumentNegative: () =>{
            inputHelpers.clicker('[data-testid="pass-button-ship_to_infusion_attach_shipping_label"]');
            inputHelpers.clicker('[data-testid="pass-button-ship_to_infusion_place_material_into_shipper"]');
            inputHelpers.clicker('[data-testid="pass-button-ship_to_infusion_activate_temperature_monitor"]');
            inputHelpers.clicker('[data-testid="fail-button-ship_to_infusion_place_summary_document"]');
            inputChecker.clearField('[data-testid="#/properties/shipping_checklist/properties/ship_to_infusion_place_summary_document_reason-input"]');
            inputChecker.nextButtonCheck('be.disabled');
        }

},

    manufacturingAirwayBill: {
    getManufacturingAirWayBillAndCompleteShipping: (scope) => {
        ...
        cy.get('[data-testid="td-stage-plane-icon"]')
          ...
          .then((text) => {
            ...
            inputHelpers.clicker('[data-testid="pass-button-ship_to_infusion_activate_temperature_monitor"]');
            inputHelpers.clicker('[data-testid="pass-button-ship_to_infusion_place_summary_document"]');
            inputHelpers.inputSingleField('[id="#/properties/shipping_checklist/properties/ship_to_infusion_additional_comments-input"]', input.mfgShippingChecklistInfusionAdditionalComments);
            inputHelpers.scanAndVerifyCoi('manufacturing-airway-bill', scope.manufacturingAirWayBill);
